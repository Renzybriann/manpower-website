/*
  File: src/pages/JobSearchPage.jsx (UPDATED)
  Description: Fetches and displays the number of openings for all jobs.
*/
...
export function JobSearchPage({ navigateTo }) {
  ...
  return (
    <section id="job-search" className="bg-white min-h-screen">
